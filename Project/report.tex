...
\end{align}
%when $s_6=0, c_6 = \pm 1$, and we can solve for $\theta_7$ using Equations~\ref{eq1} and~\ref{eq7}
%\begin{align}
%n_{x} c_1 + n_{y} s_1 &= c_{2} \left(\pm c_{345} c_{7} + s_{345} s_{7} \right) \nonumber \\
%					  &= \pm c_{2} \cos\left(\theta_{345} \mp \theta_7\right) \\
%a_{x} c_1 + a_{y} s_1 &= c_{2} \left(\pm c_{345} s_{7} - s_{345} c_{7} \right) \nonumber\\
%					  &= \pm c_{2} \cos\left(\theta_{345} \pm \theta_7\right)
%\end{align}
%For $c_6 = +1$, then,
%\begin{align}
%n_{x} c_1 + n_{y} s_1 &= + c_{2} \cos\left(\theta_{345} - \theta_7\right) \\
%a_{x} c_1 + a_{y} s_1 &= + c_{2} \cos\left(\theta_{345} + \theta_7\right)
%\end{align}
%And for $c_6 =-1$ we have,
%\begin{align}
%n_{x} c_1 + n_{y} s_1 &= - c_{2} \cos\left(\theta_{345} + \theta_7\right) \\
%a_{x} c_1 + a_{y} s_1 &= - c_{2} \cos\left(\theta_{345} - \theta_7\right)
%\end{align}
...
% \begin{align*}
% % LHS &=
% % & \left(a_{z} s_{2} + c_{2}\left(a_{x} c_{1} + a_{y} s_{1}\right) \right) s_{7} c_{6} + \left(n_{z} s_{2} + c_{2}\left(n_{x} c_{1} - n_{y} c_{1} \right) \right) c_{6} c_{7} + \left(o_{z} s_{2} + c_{2}\left(o_{x} c_{1} - o_{y} c_{1} \right) \right) s_{6}  \\
% % & \left(a_{z} s_{2} + c_{2}\left(a_{x} c_{1} + a_{y} s_{1}\right) \right) s_{6} s_{7} + \left(n_{z} s_{2} + c_{2}\left(n_{x} c_{1} - n_{y} c_{1} \right) \right) s_{6} c_{7} - \left(o_{z} s_{2} + c_{2}\left(o_{x} c_{1} - o_{y} c_{1} \right) \right) c_{6}  \\
% % & - \left(a_{z} s_{2} + c_{2}\left(a_{x} c_{1} + a_{y} s_{1}\right) \right) c_{7} + \left(n_{z} s_{2} + c_{2}\left(n_{x} c_{1} - n_{y} c_{1} \right) \right) s_{7}  \\
% & d_{6} \left(a_{z} s_{2} + c_{2}\left(a_{x} c_{1} + a_{y} s_{1}\right) \right) c_{7} - d_{6} \left(n_{z} s_{2} + c_{2}\left(n_{x} c_{1} - n_{y} c_{1} \right) \right) s_{7} - d_{7} \left(o_{z} s_{2} + c_{2}\left(o_{x} c_{1} - o_{y} c_{1} \right) \right) + \left(- d_{1} + p_{z}\right) s_{2} + c_{2}\left(p_{x} c_{1} + \frac{p_{y} \left(-c_{1}\right)}{}\right) \\
% % & \left(a_{x} s_{1} - a_{y} c_{1}\right) s_{7} c_{6} + \left(n_{x} s_{1} - n_{y} c_{1}\right) c_{6} c_{7} + \left(o_{x} s_{1} - o_{y} c_{1}\right) s_{6}  \\
% % & \left(a_{x} s_{1} - a_{y} c_{1}\right) s_{6} s_{7} + \left(n_{x} s_{1} - n_{y} c_{1}\right) s_{6} c_{7} - \left(o_{x} s_{1} - o_{y} c_{1}\right) c_{6}  \\
% % & - \left(a_{x} s_{1} - a_{y} c_{1}\right) c_{7} + \left(n_{x} s_{1} - n_{y} c_{1}\right) s_{7}  \\
% & - d_{2} + d_{6} \left(a_{x} s_{1} - a_{y} c_{1}\right) c_{7} - d_{6} \left(n_{x} s_{1} - n_{y} c_{1}\right) s_{7} - d_{7} \left(o_{x} s_{1} - o_{y} c_{1}\right) + p_{x} s_{1} - p_{y} c_{1} \\
% % & \left(- a_{z} c_{2} + \left(a_{x} c_{1} + a_{y} s_{1}\right) s_{2}\right) s_{7} c_{6} + \left(- n_{z} c_{2} + \left(n_{x} c_{1} - n_{y} c_{1} \right) s_{2}\right) c_{6} c_{7} + \left(- o_{z} c_{2} + \left(o_{x} c_{1} - o_{y} c_{1} \right) s_{2}\right) s_{6}  \\
% % & \left(- a_{z} c_{2} + \left(a_{x} c_{1} + a_{y} s_{1}\right) s_{2}\right) s_{6} s_{7} + \left(- n_{z} c_{2} + \left(n_{x} c_{1} - n_{y} c_{1} \right) s_{2}\right) s_{6} c_{7} - \left(- o_{z} c_{2} + \left(o_{x} c_{1} - o_{y} c_{1} \right) s_{2}\right) c_{6}  \\
% % & - \left(- a_{z} c_{2} + \left(a_{x} c_{1} + a_{y} s_{1}\right) s_{2}\right) c_{7} + \left(- n_{z} c_{2} + \left(n_{x} c_{1} - n_{y} c_{1} \right) s_{2}\right) s_{7} \\
% % & d_{6} \left(- a_{z} c_{2} + \left(a_{x} c_{1} + a_{y} s_{1}\right) s_{2}\right) c_{7} - d_{6} \left(- n_{z} c_{2} + \left(n_{x} c_{1} - n_{y} c_{1} \right) s_{2}\right) s_{7} - d_{7} \left(- o_{z} c_{2} + \left(o_{x} c_{1} - o_{y} c_{1} \right) s_{2}\right) - \left(- d_{1} + p_{z}\right) c_{2} + \left(p_{x} c_{1} + \frac{p_{y} \left(-c_{1}\right)}{}\right) s_{2} \\
% % & 0  \\
% % & 0  \\
% % & 0  \\
% % & 1 \\
...
% \begin{align*}
% % RHS &=
% % \cos{\left (\theta_{3} + \theta_{4} + \theta_{5} \right )}  \\
% % & 0  \\
% % & \sin{\left (\theta_{3} + \theta_{4} + \theta_{5} \right )}  \\
% & a_{3} \cos{\left (\theta_{3} \right )} + a_{4} \cos{\left (\theta_{3} + \theta_{4} \right )} \\
% % \\\sin{\left (\theta_{3} + \theta_{4} + \theta_{5} \right )}  \\
% % & 0  \\
% % & - \cos{\left (\theta_{3} + \theta_{4} + \theta_{5} \right )}  \\
% & a_{3} \sin{\left (\theta_{3} \right )} + a_{4} \sin{\left (\theta_{3} + \theta_{4} \right )} \\
% % \\0  \\
% % & 1  \\
% % & 0  \\
% % & d_{3} \\
...
a_{3} c_{3} + a_{4} c_{34} &= d_{6} \left(a_{z} s_{2} + c_{2}\left(a_{x} c_{1} + a_{y} s_{1}\right) \right) c_{7} - d_{6} \left(n_{z} s_{2} + c_{2}\left(n_{x} c_{1} - n_{y} c_{1} \right) \right) s_{7}  \\
                           % &\phantom{=} - d_{7} \left(o_{z} s_{2} + c_{2}\left(o_{x} c_{1} - o_{y} c_{1} \right) \right) + \left(- d_{1} + p_{z}\right) s_{2} + c_{2}\left(p_{x} c_{1} - p_{y} c_{1}\right) \\
